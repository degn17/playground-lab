...
- Confirmed the live GitHub Pages deployment is working
- Added a visible `v0.1` version badge near the homepage title

## Deployment status

The live GitHub Pages deployment is working and can show the updated V0.1 homepage with the version badge after changes are merged into `main`.
